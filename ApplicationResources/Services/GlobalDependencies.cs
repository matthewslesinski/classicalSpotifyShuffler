...
namespace ApplicationResources.Services
{
	public static class GlobalDependencies
	{
		...
		{
			if (Interlocked.CompareExchange<ServiceProviderDisposableWrapper>(ref _globalDependencyContainerWrapper, serviceProviderWrapper, null) != null)
		...
		public interface IServiceBuilder
		{
			...
			IServiceBuilder AddGlobalServiceAsync<ServiceT, ImplementationT>() where ServiceT : class where ImplementationT : class, ServiceT, IAsyncInitialized, new();
			IDisposable Build();
		}
